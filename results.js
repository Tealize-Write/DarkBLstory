...
const RESULT_META = {
  ...
  A_SCHEME_3:  { label:"以愛為名的沉默暴徒", short:"A · 守護 (GRD)" },
  A_CHAOS_1:   { label:"弒愛偏執・群獸的支配者", short:"A · 支配 (CRP)" },
  ...
  R_SCHEME_2:  { label:"無法逃離的美麗囚徒", short:"R · 執著 (OBS)" },
  R_CHAOS_1:   { label:"被囚禁後仍選擇留下的人", short:"R · 失控 (LSC)" },
  R_CHAOS_2:   { label:"被愛碾碎仍選擇再死一次的人", short:"R · 殉從 (CMP)" },
...
const resultsData = {
  ...
  A_CHAOS_1:{
    ...
    soulName:"無情獸群攻",
    soulDesc:"你不懂什麼叫做「適可而止」，你只知道你想要的，你就必須全部拿到，那怕是糟蹋了全世。",
    danger:"極高", dangerFill:"100%",
    attr:"破壞指數", attrVal:"Max", attrFill:"100%",
    escape:"5%",
    quote:"「哥哥，如果你愛我，你得證明才行。」",
    guide:"對你來說，愛可以是很多面向，是等價交換，是工於心計，是得他得像你愛他一樣來深愛你。但在心底深處，你明白，你的愛，從來就不是無條件付出。"
    bookName:"《兩兄弟》",
    bookAuthor:"吳墨",
    bookFairy:"兩兄弟",
    bookTags:["劍", "抹布", "精神崩潰"],
