...
const RESULT_META = {
  /* 攻方對應 */
  A_CONTROL_1: { label: "深淵凝視者・不允許你逃離的執念" },
  A_CONTROL_2: { label: "焚毀一切也要得到你的人" },
  A_CONTROL_3: { label: "神性冷光下的禁忌之心" },
  A_SCHEME_1:  { label: "規則操盤者・勝利至上的賭徒" },
  A_SCHEME_2:  { label: "黑暗中低語的引誘者" },
  A_SCHEME_3:  { label: "以愛為名的沉默暴徒" },
  A_CHAOS_1:   { label: "弒愛偏執・群獸的支配者" },
  A_CHAOS_2:   { label: "原始獸性的王者" },
  A_DEVOTION_1:{ label: "失控守護者・為愛撕裂王國的黑龍" },
  A_DEVOTION_2:{ label: "甜蜜牢籠的統治者" },
  A_DEVOTION_3:{ label: "瘋狂旋律的操控者" },

  /* 受方對應 */
  R_CONTROL_1: { label: "唯一照亮黑暗的溫暖火種" },
  R_CONTROL_2: { label: "冷靜面具下的動搖靈魂" },
  R_CONTROL_3: { label: "理性崩塌前的最後防線" },
  R_SCHEME_1:  { label: "在慾望深淵中綻放的誘惑" },
  R_SCHEME_2:  { label: "無法逃離的美麗囚徒" },
  R_CHAOS_1:   { label: "被囚禁後仍選擇留下的人" },
  R_CHAOS_2:   { label: "被愛碾碎仍選擇再愛一次的人" },
  R_DEVOTION_1:{ label: "笑著走進深淵的共犯" },
  R_DEVOTION_2:{ label: "被禁慾束縛的王族之心" },
};
...
const resultsData = {
  ...
  A_CHAOS_1: {
    ...
    soulName: "無情獸群攻",
    soulDesc: "你不懂什麼叫做「適可而止」，你只知道你想要的，就必須全部拿到，哪怕是糟蹋了全世。",
    danger: "極高",
    dangerFill: "100%",
    attr: "破壞指數",
    attrVal: "Max",
    ...
    escape: "5%",
    quote: "「如果你愛我，你得證明才行。」",
    guide: "你知道自己也能裝得很溫柔。可以關心，可以哄騙，可以一步一步把人留住。可你比誰都清楚——你的愛，從來不是無條件給予。",
    bookName: "《兩兄弟》",
    bookAuthor: "吳墨",
    bookFairy: "兩兄弟",
    bookTags: ["劍", "抹布", "精神崩潰"],
  ...
  R_CHAOS_2: {
    ...
    attrFill: "100%",
    escape: "2%",
    quote: "不要隨便說愛我，因為我會深信不疑的。",
    guide: "如果愛需要祭品，那你會選擇走上祭壇，一千次一萬次，這樣或許有一次，他會停下來，看著你，相信你們曾愛過。",
    bookName: "《兩兄弟》",
    bookAuthor: "吳墨",
    bookFairy: "兩兄弟",
    bookTags: ["劍", "抹布", "精神崩潰"],
