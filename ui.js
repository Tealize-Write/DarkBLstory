...
function getEmblemSVG(code) {
  ...
  switch(code) {
    ...
    case 'A_DEVOTION_1': return `<svg ${baseProps}>${mysticCircle}<g stroke-width="2.5"><path d="M 32 30 C 26 16, 50 10, 42 1 C 60 10, 40 20, 44 25 Q 58 15, 55 14 Q 58 25, 50 30 Q 58 30, 58 34 Q 52 40, 46 40 Q 42 46, 41 50 Q 38 56, 32 56 Q 26 56, 23 50 Q 22 46, 18 40 Q 12 40, 6 34 Q 6 30, 14 30 Q 6 25, 9 14 Q 6 15, 20 25 C 24 20, 4 10, 22 1 C 14 10, 38 16, 32 30 Z" fill="var(--bg)" stroke="currentColor" stroke-linejoin="round"/><circle cx="24" cy="37" r="3.5" fill="currentColor" stroke="none"/><circle cx="40" cy="37" r="3.5" fill="currentColor" stroke="none"/><circle cx="23" cy="36" r="1.2" fill="var(--bg)" stroke="none"/><circle cx="39" cy="36" r="1.2" fill="var(--bg)" stroke="none"/><path d="M 20 31 Q 24 29, 28 32 M 44 31 Q 40 29, 36 32" stroke-width="1.5" fill="none" stroke-linecap="round"/><line x1="17" y1="42" x2="21" y2="42" stroke-width="1.5" stroke-linecap="round"/><line x1="43" y1="42" x2="47" y2="42" stroke-width="1.5" stroke-linecap="round"/><polygon points="29,50 26,52 29,54" fill="currentColor" stroke="none"/><polygon points="35,50 38,52 35,54" fill="currentColor" stroke="none"/><path d="M 32 30 V 44" stroke-width="1.5"/><path d="M 30 45 L 32 47 L 34 45" stroke-width="1.5" fill="none" stroke-linecap="round"/></g></svg>`;
    ...
    case 'R_CONTROL_1': return `<svg ${baseProps}>${mysticCircle}<defs><clipPath id="ball-clip"><circle cx="32" cy="32" r="19" /></clipPath></defs><circle cx="32" cy="32" r="20" fill="var(--bg)" stroke="none" /><g clip-path="url(#ball-clip)"><path d="M 16 10 A 30 30 0 0 1 16 54 M 48 10 A 30 30 0 0 0 48 54" stroke-width="2" /><path d="M 15 18 L 19 14 L 23 18 M 18 26 L 22 22 L 26 26 M 20 34 L 24 30 L 28 34 M 18 42 L 22 38 L 26 42 M 15 50 L 19 46 L 23 50" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round" /><path d="M 41 18 L 45 14 L 49 18 M 38 26 L 42 22 L 46 26 M 36 34 L 40 30 L 44 34 M 38 42 L 42 38 L 46 42 M 41 50 L 45 46 L 49 50" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round" /></g><circle cx="32" cy="32" r="20" fill="none" stroke="currentColor" stroke-width="2" /></svg>`;
    ...
    case 'R_CHAOS_2': return `<svg ${baseProps}>${mysticCircle}<g stroke-width="2.5"><path d="M 26 24 L 23 16 L 26 12 L 23 10 L 20 15 L 15 17 L 16 21 L 19 19 L 21 24 Z" fill="currentColor" stroke="none" /><path d="M 31 22 C 32 12, 40 10, 46 14 L 44 19 C 40 16, 35 16, 34 23 Z" fill="currentColor" stroke="none" /><path d="M 46 26 L 50 24 L 51 26 L 47 28 Z" fill="currentColor" stroke="none" /><path d="M 48 31 L 52 29 L 53 31 L 49 33 Z" fill="currentColor" stroke="none" /><path d="M 28 25 C 14 25, 12 40, 24 51 C 28 55, 32 58, 35 56 C 42 50, 46 42, 45 35 C 44 26, 38 22, 33 24 C 30 25, 29 25, 28 25 Z" fill="currentColor" stroke="none" /><g stroke="var(--bg)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M 45 33 Q 40 34, 37 35" /><path d="M 37 35 Q 32 36, 26 38" /><path d="M 37 35 L 35 37" /><path d="M 35 37 Q 33 41, 32 45" /><path d="M 35 37 Q 37 42, 39 46" /></g><path d="M 34 59 C 31 62, 31 66, 34 66 C 37 66, 37 62, 34 59 Z" fill="currentColor" stroke="none"/></g></svg>`;
